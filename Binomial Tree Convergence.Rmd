---
title: "Monte Carlo Convergence of the In-the-Money Binomial Tree"
...
ggplot(data = Binomial_Tree_Convergence, aes(x = Column1, y = Column2)) +
  ...
  labs(title = "Convergence of Binomial Tree with Varying Number of Periods", x = "Number of Periods, n", y = "Value of In-the-Money Put Option") +
  theme_classic() +
  theme(
...
We can conclude, that to an accuracy of 5 decimal places, the In-the-money American Put option on the S&P 500 would converge to a value of $2.32429. This we be used as our basis of comparison for the 
